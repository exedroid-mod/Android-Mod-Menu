...
JNIEXPORT jstring JNICALL /** Zero protection, It can be found in any disasembler 
It can be hidden
**/
...
JNIEXPORT jobjectArray JNICALL /** Zero protection, It can be found in any disasembler 
It can be hidden
**/
